...
module RubyEventStore
  module Mappers
    ...
    RSpec.describe EncryptionMapper do
      ...
      let(:domain_event)    { TimestampEnrichment.with_timestamp(SomeEventWithPersonalInfo.new(data: data, metadata: metadata, event_id: event_id), time) }
      ...
      context 'when ReverseYamlSerializer serializer is provided' do
        ...
        specify '#serialized_record_to_event returns event instance' do
          ...
          domain_event = TimestampEnrichment.with_timestamp(
